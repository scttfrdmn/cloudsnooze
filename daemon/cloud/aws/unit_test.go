...
func TestNewProviderUnit(t *testing.T) {
	config := Config{
		Region:             "us-west-2",
		EnableTags:         true,
...
// TestStopTagPollingUnit tests the StopTagPolling function without external dependencies
func TestStopTagPollingUnit(t *testing.T) {
	provider := NewProvider(Config{
		Region:             "us-west-2",
		TagPollingEnabled:  true,
